        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex-shrink-0 group">
            <NavLink to="/" className="block">
              <h1 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-orange-500 via-orange-400 to-orange-300 bg-clip-text text-transparent hover:scale-105 transition-transform duration-300 cursor-pointer">
            ...
            <div className="flex items-center gap-4">
              {navItems.map((item, index) => (
                <NavLink
                  ...
                  to={item.path}
                  className={({ isActive }) =>
                    `relative inline-flex items-center justify-center px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 group ${
                      isActive
                ...
                >
                  {({ isActive }) => (
                    <>
                      ...
                      {isActive && (
                        <div className="absolute inset-0 bg-gradient-to-r from-orange-500/30 to-orange-400/30 rounded-full animate-pulse z-0" />
                      )}
          ...
          <div className="px-6 py-6 space-y-3">
            {navItems.map((item, index) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `block w-full text-left px-5 py-4 rounded-xl text-base font-medium transition-all duration-300 transform ${
                    isActive
