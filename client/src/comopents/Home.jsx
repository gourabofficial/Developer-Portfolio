        ...
        <div className="space-y-8">
          ...
          <div className="opacity-0 animate-[fadeInUp_1s_ease-out_1s_forwards]">
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <button className="group relative px-8 py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold rounded-full shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 transition-all duration-300 hover:scale-105 hover:-translate-y-1">
              ...
              <button className="group px-8 py-4 border-2 border-orange-500 text-orange-400 font-semibold rounded-full hover:bg-orange-500 hover:text-white transition-all duration-300 hover:scale-105 hover:-translate-y-1">
              ...
              {[
                ...
                return (
                  <a
                    ...
                    className={`group p-4 rounded-full border border-gray-600 hover:border-orange-500 transition-all duration-300 hover:scale-110 hover:-translate-y-1 hover:shadow-lg hover:shadow-orange-500/25 ${social.color}`}
                    style={{ animationDelay: `${1.4 + index * 0.1}s` }}
                    title={`Visit my ${social.name}`}
                  >
                    <IconComponent className="w-6 h-6 text-gray-400 group-hover:text-orange-400 transition-colors duration-300" />
                  </a>
                )
              })}
            </div>
